...
//	“basePath”="http:localhost:8080/blog/"
%>
<html>
<head>
	<title>我的博客</title>
<%--	以后页面跳转都是以basepath为基准--%>
	<base href="<%=basePath%>">
...
<%--			target="_blank"：点击跳转到新页面--%>
<%--			href="javascript:void(0);" 执行void(0); 点击不跳转，什么都不做 --%>
			<a id="article_add_btn" href="jsp/articleDetail.jsp?id=1&type=add" class="btn btn-default" role="button" target="_blank">发表新文章</a>
			<a id="article_update_btn"  class="btn btn-default" role="button" target="_blank">修改</a>
			<a id="article_delete_btn"  class="btn btn-default" role="button">删除</a>
		</div>
...
<script type="text/javascript">
	...
	var devUri = "";
	if (typeof devToken === 'string'  &&  devToken.length  >  0  && devToken!='null'){
