...
public class DBUtil {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/myBlog?user=root&password=MYsql123!&useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    //创建连接池
